...
class SolitarioThumbAndPouch:
    ...
    def jugar(self, jugada): #utilizar funciones auxiliares
        """Efectúa una movida.
    ...
    def _subpila_a_pila(self, origen, destino): #igual a solitario_claseico.py(no hace falta cambiarlo,se los dejo como comentario)
